...
milestones_with_monthly_hours <- milestones_monthly_hours %>% 
  mutate(Month_Calculated_For__c = dmy(paste0("1", Calculated_For__c)) %m+% months(1),
         Submitted_against_Planned__c = Planned_Hours__c - Submitted_Hours__c,
         Under_Planned_Hours__c = Planned_Hours__c - Submitted_Hours__c,
         `Planned Hours Completed` = Submitted_against_Planned__c + Under_Planned_Hours__c,
         .keep = "unused") %>% 
...
hour_overages_region <- create_metrics(milestones_with_monthly_hours,
                                       ...
                                       .groups = c(Group = Group,
                                                   Month = Month_new_project_hours_date,
                                                   Region = Account__r.Reporting_Region__c),
                                       c(`Hour Overages` = Submitted_against_Planned__c))
