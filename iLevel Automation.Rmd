...
prepare_output <- function(keep_cols = c(Group, Metric, Month, Region, Calculation, Value), ...){
  ...
  bind_rows(...) %>%
    ...
    relocate(Group, Subgroup, Metric, seq(as.Date(from_date), as.Date(to_date), by="months") %>% as.character(), "Month Total", "Grand Total")
