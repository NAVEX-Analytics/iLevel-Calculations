...
milestones <- milestones %>% 
  mutate(Product = Product__r.Super_Product_Family__c,
         ...
         new_project_hours_date = case_when(pse__Project__r.pse__Opportunity__r.CloseDate >= from_date & 
                                            ...
                                            TRUE ~ NA),
         across(c(new_project_hours_date, pse__Project__r.pse__Opportunity__r.CloseDate, Actual_Go_Live__c, CreatedDate), ~ floor_date(., "months"), .names = "Month_{.col}"))
...
milestones_with_monthly_hours <- milestones_monthly_hours %>% 
  ...
  filter(Month_Calculated_For__c <= Month_Actual_Go_Live__c,
